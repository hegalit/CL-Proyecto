...
public:
  ...
  antlrcpp::Any visitArrLeftExpr(AslParser::ArrLeftExprContext *ctx);
  ...
  antlrcpp::Any visitLeftExpr(AslParser::LeftExprContext *ctx);
...
private:
  ...
  //CUSTOM MACROS TO EASE CODE GENERATION

  std::string coerceType(instructionList &code,
                         TypesMgr::TypeId destType,
                         TypesMgr::TypeId srcType,
                         const std::string &srcAddr);

  std::string reference(instructionList &code,
                        TypesMgr::TypeId srcType,
                        const std::string &srcAddr);

  std::string dereference(instructionList &code,
                          std::string &srcAddr);

  //Modulo
  instructionList instruction_MOD(const std::string &dest,
                                  const std::string &param1,
                                  const std::string &param2);
  //Not Equal
  instructionList instruction_NE(const std::string &dest,
                                 const std::string &addr1,
                                 const std::string &addr2);
  //Float Not Equal
  instructionList instruction_FNE(const std::string &dest,
                                  const std::string &addr1,
                                  const std::string &addr2);
  //General loops
  instructionList instruction_LOOP(instructionList &condCode,
